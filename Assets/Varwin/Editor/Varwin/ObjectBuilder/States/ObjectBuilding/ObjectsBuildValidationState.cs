...
namespace Varwin.Editor
{
    ...
    public class ObjectsBuildValidationState : BaseObjectBuildingState
    {
        ...
        private bool ValidateObjectNames(VarwinObjectDescriptor objectDescriptor, out string objectNameErrors)
        {
        ...
        /// <returns>true - успешная валидация. false - неуспешная валидация.</returns>
        private bool ValidateAssetBundleParts(VarwinObjectDescriptor descriptor, out string errorsString)
        {
        ...
        /// <param name="objectNameErrors">Строкас с текстом ошибки валидации имени объекта.</param>
        /// <returns>Строка с текстом ошибок.</returns>
        private string GetErrorsMessage(string bundlePartsErrors, string objectNameErrors)
        {
            var sb = new StringBuilder();
